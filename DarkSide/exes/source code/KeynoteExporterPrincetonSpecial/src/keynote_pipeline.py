"""
KeynoteExporter PrincetonSpecial Pipeline - Core Processing Logic

This module contains the PrincetonSpecial pipeline orchestration logic that was previously
in KeynoteExporter.py. It handles the complete 6-step processing pipeline tailored for
the PrincetonSpecial workflow.
"""
...
def run_pipeline(excel_path=None, output_dir=None):
    """
    High-Level KeynoteExporter PrincetonSpecial Pipeline Orchestrator
    
    This function orchestrates the complete 6-step pipeline by delegating work
    to specialized modules. It provides a clean, high-level interface for PrincetonSpecial.
    """
    print("=" * 80)
    print("KEYNOTE EXPORTER PRINCETONSPECIAL PIPELINE - STARTING PROCESSING")
    print("=" * 80)
    
    # Default Excel path
    if excel_path is None:
        excel_path = r"C:\Users\szhang\github\ennead-llp\EnneadTab-OS\DarkSide\exes\source code\KeynoteExporterPrincetonSpecial\sample excel\_WorkingIN_PORGRESS.xlsm"
    ...
    try:
        ...
        print(f"[OK] PrincetonSpecial configuration loaded from: {config.config_path}")
        ...
        # ========================================================================
        print("\n" + "=" * 80)
        print("KEYNOTE EXPORTER PRINCETONSPECIAL PIPELINE COMPLETED SUCCESSFULLY!")
        print("=" * 80)
        ...
        logger.exception("Error while running KeynoteExporter PrincetonSpecial pipeline")
        raise
