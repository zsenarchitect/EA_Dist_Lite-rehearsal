"""
HTML tree visualizer for KeynoteExporter PrincetonSpecial.
...
<div style="margin: 0 20px 20px 20px;">
  <p>Division → Section → Entries. Use search to filter; expand/collapse controls affect the whole tree.</p>
""")
