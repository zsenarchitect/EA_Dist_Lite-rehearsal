...
class BaseGUI(tk.Tk):
    ...
    def rounded_corners(self):
        self.canvas = tk.Canvas(self, bg='dimgray', highlightthickness=0)
...
class App(BaseGUI):
    ...
    def create_widgets(self):
        self.label = ttk.Label(self.canvas, text="Available Apps", background="dimgray", foreground="white")
...
def main():
    app = App(_Exe_Util.EXE_PRODUCT_FOLDER)
    app.mainloop()
