...
from constants import KNOWLEDGE_RHINO_FILE
if not os.path.exists(KNOWLEDGE_RHINO_FILE):
    with open(KNOWLEDGE_RHINO_FILE, 'w') as file:
        json.dump({}, file)
...
class KnowledgeHandler:
    ...
    def update_database(cls):
        ...
        if cls._is_new_member:
            with open(KNOWLEDGE_RHINO_FILE, 'w') as f:
