...
Do not use any Plugin dependency
...
from constants import RHINO_FOLDER, SPECIAL_LIST_KEY, DIST_RUI_CLASSIC, DIST_RUI_MODERN, INSTALLATION_RUI, RHINO_INSTALLER_SETUP_FOLDER, ACTIVE_MODERN_RUI
...
RUI_SETS = [
    ...
    {
     "search_folder": RHINO_FOLDER,
     "out_rui": DIST_RUI_CLASSIC,
     "version": 7
    },
    {
     "search_folder": RHINO_FOLDER,
     "out_rui": DIST_RUI_MODERN,
     "version": 8
    },
    {
     "search_folder": RHINO_FOLDER,
     "out_rui": ACTIVE_MODERN_RUI,
     "version": 8
    },
]
...
class RuiWriter:
    ...
    def __init__(self, search_folder, out_rui, is_modern_rui) -> None:
        # self.main_data = OrderedDict()
        self.search_folder = search_folder
        self.out_rui = out_rui
        self.main_data = dict()
        self.is_modern_rui = is_modern_rui
    ...
    def assign_rui_basic(self):
        self.main_data["@major_ver"] = "5" if self.is_modern_rui else "3"
        ...
        self.main_data["@dpi_scale"] = "150" if self.is_modern_rui else "100"
    ...
    def get_toolbar_group_data(self):
        ...
        if self.is_modern_rui:
            group_data.pop("@dock_bar_guid32")
        ...
        group_data["dock_bar_info"] = {
                "@dpi_scale": "150" if self.is_modern_rui else "100",
                "@dock_bar": "False",
                "@docking": "True",
                "@horz": "False",
                "@visible": "True",
                ...
                "@bar_id": "59522",
                "@mru_width": "386" if self.is_modern_rui else "868",
                "@point_pos": "25,0" if self.is_modern_rui else "57,0",
                "@float_point": "646,309" if self.is_modern_rui else "1454,694",
                "@rect_mru_dock_pos": "25,0,53,403" if self.is_modern_rui else "57,0,118,907",
                "@dock_location_u": "59420",
                "@dock_location": "left" if self.is_modern_rui else "right",
                "@float_size": "191,62"
            }
    ...
    def save_to_rui(self):
        ...
        red_text = "\033[31m"
        reset_color = "\033[0m"
        print("\nSuper rui has been saved, you are welcome!\n{}{}{}".format(red_text, self.out_rui, reset_color))
...
def run():
    for item in RUI_SETS:
        ...
        is_mo_rui = item["version"] >= 8
        RuiWriter(search_folder, out_rui, is_mo_rui).run()
###################################################################
